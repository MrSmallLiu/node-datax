...
var PostgresReader = /** @class */ (function () {
    ...
    PostgresReader.prototype.read = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, dataRes;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = { data: [], state: this.readState };
                        if (this.readState === datax_1.SyncState.finish) {
                            return [2 /*return*/, result];
                        }
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                _this.cursor.read(_this.batchSize, function (err, rows) {
                                    if (err) {
                                        reject(err);
                                        return;
                                    }
                                ...
                                _this.readState = datax_1.SyncState.error;
                                result.msg = '读取失败';
                                result.err = err;
                            })];
                    case 1:
